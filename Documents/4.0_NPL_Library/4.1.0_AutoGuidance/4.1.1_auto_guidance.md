...
- Signature: `AutoGuidance.define(target: Datum, context: Datum = None)`
...
- Signature: `AutoGuidance.fill(target: Datum, context: Datum = None)`
...
- Signature: `AutoGuidance.satisfy(condition: Datum, target: Datum = None, context: Datum = None, principle: Datum = None)`
...
- Parameters:
    ...
    - target (Datum = None): Datum 句柄，指向需要调整状态以满足条件的目标 Object。如果为 None，则表示满足条件的行为不针对特定 Object。
...
- Signature: `AutoGuidance.act(context: Datum = None)`
