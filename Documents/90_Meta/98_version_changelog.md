...
*   **版本**: 0.1.x
  ...
  **主要变更:**
  ...
  3.  **Canvas 相关更新:**
      *   引入 `Canvas` 概念，作为交互式 NPL 运行环境，取代原来的`Shell`。
...
*   **版本**: 0.3.0
  ...
  *   **主要变更:**
	  ...
	  *    将 Shell 的概念加回来，作为另一种简单的 ACP Textual 的实现方式。可能有助于LLM利用大量的Shell示例进行迁移。
	  *    实验证明不需要LingUnit类。
